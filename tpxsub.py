...
def search_in_website(sb, search):
    # Wait for the search input to be present
    sb.wait_for_element(By.CSS_SELECTOR, "input.herald-search-input", timeout=10)
    
    # Type the search query directly using the selector string
    sb.type("input.herald-search-input", search)

    # Click the submit button to perform the search
    sb.click(By.CSS_SELECTOR, "button.herald-search-submit")
